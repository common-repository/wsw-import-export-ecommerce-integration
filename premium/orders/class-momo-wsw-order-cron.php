...
class MoMo_WSW_Order_Cron {
	...
	public function __construct() {
		$as_order_import_settings = get_option( 'momo_wsw_as_order_import_settings' );
		$as_order_export_settings = get_option( 'momo_wsw_as_order_export_settings' );
		$enable_as_order_import   = isset( $as_order_import_settings['enable_as_order_import'] ) ? $as_order_import_settings['enable_as_order_import'] : 'off';
		$enable_as_order_export   = isset( $as_order_export_settings['enable_as_order_export'] ) ? $as_order_export_settings['enable_as_order_export'] : 'off';
		$this->cron_hooks         = array(
			'iorder' => '_momo_wsw_import_order_schedule',
			'eorder' => '_momo_wsw_export_order_schedule',
		);
		...
		if ( 'on' === $enable_as_order_export ) {
			...
			add_action( $this->cron_hooks['eorder'], array( $this, 'momo_wsw_export_order_schedule' ), 15 );
		}
	}
	/**
	...
	public function momo_wsw_import_order_schedule() {
		global $momowsw;
		$momowsw->premium->synco->momo_wsw_import_orders_from_shopify();
	}
	/**
	...
	public function momo_wsw_enable_order_import_cron() {
		...
		$days   = isset( $as_order_import_settings['as_order_import_days'] ) && ! empty( $as_order_import_settings['as_order_import_days'] ) ? $as_order_import_settings['as_order_import_days'] : 1;
		$hour   = isset( $as_order_import_settings['as_order_import_hour'] ) && ! empty( $as_order_import_settings['as_order_import_hour'] ) ? $as_order_import_settings['as_order_import_hour'] : '00';
		$minute = isset( $as_order_import_settings['as_order_import_minute'] ) && ! empty( $as_order_import_settings['as_order_import_minute'] ) ? $as_order_import_settings['as_order_import_minute'] : '00';
	...
	public function momo_wsw_export_order_schedule() {
		global $momowsw;
		$momowsw->premium->synco->momo_wsw_export_orders_to_shopify();
	}
	/**
	...
	public function momo_wsw_enable_order_export_cron() {
		...
		$days   = isset( $as_order_export_settings['as_order_export_days'] ) && ! empty( $as_order_export_settings['as_order_export_days'] ) ? $as_order_export_settings['as_order_export_days'] : 1;
		$hour   = isset( $as_order_export_settings['as_order_export_hour'] ) && ! empty( $as_order_export_settings['as_order_export_hour'] ) ? $as_order_export_settings['as_order_export_hour'] : '00';
		$minute = isset( $as_order_export_settings['as_order_export_minute'] ) && ! empty( $as_order_export_settings['as_order_export_minute'] ) ? $as_order_export_settings['as_order_export_minute'] : '00';
