...
global $momowsw;
$logs = $momowsw->logs->momo_wsw_get_logs( 'order' );
...
<div class="momo-admin-content-box">
	<div class="momo-be-table-header">
		<h3><?php esc_html_e( 'Order Logs', 'momowsw' ); ?></h3>
	</div>
	<div class="momo-ms-admin-content-main momowsw-as-export-main" id="momowsw-momo-wsw-as-export">
		...
		<div class="momo-be-section">
			<h2><?php esc_html_e( 'Order Logs', 'momowcext' ); ?></h2>
			...
			<div class="momo-be-buttons-block">
				<span class="momo-be-btn momo-be-btn-secondary momowsw-admin-clear-order-logs" data-type="order">
