		...
		<div class="momo-be-buttons-block">
			...
			<div class="momo-be-block momo-mb-10">
				<span class="momo-be-toggle-container" momo-be-tc-yes-container="enable_product_export">
					<label class="switch">
						<input type="checkbox" class="switch-input" name="momo_wsw_es_export[enable_product_export]" autocomplete="off" <?php echo esc_attr( $enable_product_export ); ?> >
				...
				<div class="momo-be-tc-yes-container" id="enable_product_export">
					<div class="momo-be-block">
						<span class="momo-be-toggle-container">
							<label class="switch">
								<input type="checkbox" class="switch-input" name="momo_wsw_es_export[export_product_variants]" autocomplete="off" <?php echo esc_attr( $export_product_variants ); ?> >
								<span class="switch-label" data-on="Yes" data-off="No"></span>
								<span class="switch-handle"></span>
							</label>
						</span>
					...
					<div class="momo-be-block">
						<span class="momo-be-toggle-container">
							<label class="switch">
								<input type="checkbox" class="switch-input" name="momo_wsw_es_export[export_product_tags]" autocomplete="off" <?php echo esc_attr( $export_product_tags ); ?> >
								<span class="switch-label" data-on="Yes" data-off="No"></span>
								<span class="switch-handle"></span>
							</label>
						</span>
					...
					<div class="momo-be-block">
						<p>
							...
							<select class="block" name="momo_wsw_es_export[product_status]" <?php echo esc_attr( $disabled ); ?> >
